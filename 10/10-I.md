...
¡Perfecto! Aquí tienes un **tutorial paso a paso** para generar un **certificado SSL autofirmado** en **Ubuntu 20.04** para el dominio `example.com`, y luego configurarlo en **Nginx** con **redirección de HTTP a HTTPS**.
