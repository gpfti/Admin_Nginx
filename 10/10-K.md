...
* **Servidor B**: [http://localhost:8081/docs](http://localhost:8081/docs) (muestra la documentación de Tomcat).
...
Configura Nginx como balanceador de carga para `midominio.com`, distribuyendo peticiones entre los dos servidores Tomcat locales. El primer backend responde con la página raíz (`/`) y el segundo con la ruta `/docs`, para que podamos distinguir visualmente cuál responde. Si uno de los servidores falla, el otro debe continuar respondiendo sin interrupciones. Cuando el servidor caído se recupere, Nginx debe reintegrarlo automáticamente.
