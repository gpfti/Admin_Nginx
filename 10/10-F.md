...
Estas variables de respuesta del cliente, se utilizan, por ejemplo a la hora de contruir el log con `log_format` introducido en: el [Apartado de Configuración de NGINX, o 10-C](10-C.md) y que debemos revisar con más detalle en:
