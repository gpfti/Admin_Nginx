...
* `proxy_pass` redirige el tráfico al backend.
* Las directivas `proxy_set_header` garantizan que el servidor backend reciba información del cliente original (como IP, host y protocolo).
