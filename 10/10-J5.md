...
Para instalar **`wrk`**, una herramienta de benchmarking HTTP muy eficiente y adecuada para probar el rendimiento de NGINX bajo carga, sigue estos pasos según tu sistema. Para sistemas basados en Ubuntu, los pasos específicos son:
