...
http {
    ...
    server {
        ...
        # --- HTTP Location Block ---
        location / {
            root /var/www/html/;       # ⚠️ Corregido: era /var/ww/html/
            index index.html;          # ⚠️ Corregido: era indexhtml
        }
    ...
    server {
        listen 443 ssl;
        server_name ejemplo.com www.ejemplo.com;  # ⚠️ Faltaba el punto y coma
