...
Pero este comando nos los da todos, los que vienen "de serie" y los que hemos activos con a2enmod. Si hay algún módulo que cargamos dinámicamente desde LoadModule de la configuración, no está incluido aquí.
...
Puedes usar distintos archivos de configuración y controlar manualmente qué incluir según qué módulos están activos, aunque, realmente, si los modulos están en: `/etc/nginx/modules-enabled/`, es quelos has habilitado mediante un enlace blando (ejemplo linux) desde el sistema operativo.
